...
dir='/afs/inf.ed.ac.uk/group/teaching/asr/corpora/ASR19_ALL'
conf='/afs/inf.ed.ac.uk/user/s17/s1789342/asrworkdir/conf'
...
data_dir='/afs/inf.ed.ac.uk/user/s17/s1789342/asrworkdir/data'
#cd $dir_path
for new_dir in train test my_test
do
...
gender_dir='/afs/inf.ed.ac.uk/user/s17/s1789342/asrworkdir/my-local'
while read spk
do
  spkid=$spk
